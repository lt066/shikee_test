 ...
 */
public class MyGridAdapter extends ArrayAdapter<Item_data>
{
    private int mResource;

    public MyGridAdapter(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageView = (ImageView) item_view.findViewById(R.id.img_grid_item);
